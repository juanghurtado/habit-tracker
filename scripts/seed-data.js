...
const habits = [
  {
    ...
    icon: "Dumbbell",
    type: "good",
    color: "oklch(0.58 0.20 235)",
    buttonLabel: "Crushed it!",
    createdAt: day(90).toISOString(),
  },
  {
    id: id(),
    name: "Read",
  ...
  },
  {
    ...
    icon: "Brain",
    type: "good",
    color: "oklch(0.70 0.12 225)",
    buttonLabel: "Yes!",
    createdAt: day(60).toISOString(),
  },
  {
    id: id(),
    name: "Smoking",
  ...
  },
  {
    ...
    icon: "Moon",
    type: "bad",
    color: "oklch(0.52 0.20 35)",
    buttonLabel: "Ugh...",
    createdAt: day(45).toISOString(),
  },
];
...
habits.forEach((habit, hi) => {
  const startDaysAgo = Math.round(
    (Date.now() - new Date(habit.createdAt).getTime()) / 86_400_000
  );
...
console.log(
  `✅ Seeded ${habits.length} habits with ${completions.length} completions over 90 days. Refresh to see.`
);
